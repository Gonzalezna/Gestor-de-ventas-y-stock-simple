...
/**
 * Diálogo para actualizar productos
 */
public class DialogoActualizarProducto extends JFrame {
    ...
    private Producto productoOriginal; // Producto que se está actualizando
    
    
    public DialogoActualizarProducto(ProductoPanel panelPrincipal, Producto producto) {
    ...
    private void inicializarComponentes() {
        ...
        // Botón
        botonActualizar = crearBoton("Actualizar", new Color(37, 99, 235), e -> actualizarProducto());
    }
    ...
    private JTextField crearCampoTexto(String placeholder) {
        ...
        } else if (placeholder.contains("Precio")) {
            configurarSoloNumeros(campo);
    ...
    private void cargarProveedores() {
        try {
            ...
            System.out.println("Proveedores cargados en DialogoActualizarProducto: " + proveedores.size());
    ...
    private void cargarDatosProducto() {
        if (productoOriginal != null) {
            campoId.setText(String.valueOf(productoOriginal.getId()));
            campoNombre.setText(productoOriginal.getNombre());
            campoDescripcion.setText(productoOriginal.getDescripcion());
            campoPrecioCompra.setText(productoOriginal.getPrecioCompra().toString());
            campoPrecioVenta.setText(productoOriginal.getPrecioVenta().toString());
            campoStock.setText(String.valueOf(productoOriginal.getStock()));
            campoCategoria.setText(productoOriginal.getCategoria());
            
            // Cargar estado activo del producto
            campoActivo.setSelectedIndex(productoOriginal.getActivo() ? 0 : 1);

            // Cargar proveedor si existe
            if (productoOriginal.getProveedor() != null) {
                proveedorSeleccionado = productoOriginal.getProveedor();
                campoProveedor.setText(proveedorSeleccionado.getNombre());
            } else {
    ...
    private void actualizarProducto() {
        try {
            System.out.println("=== INICIANDO ACTUALIZACIÓN DE PRODUCTO ===");
            ...
            producto.setId(productoOriginal.getId()); // Mantener el ID original
            System.out.println("Producto obtenido del formulario: " + producto.getNombre());
            
            controladorProducto.actualizarProducto(producto);
            System.out.println("Producto actualizado en base de datos exitosamente");
    ...
    private Producto obtenerProductoDelFormulario() {
        ...
        producto.setActivo(campoActivo.getSelectedIndex() == 0);

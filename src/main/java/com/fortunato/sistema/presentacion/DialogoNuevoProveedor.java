...
/**
 * Diálogo para ingresar proveedores
 */
public class DialogoNuevoProveedor extends JFrame {
    ...
    public DialogoNuevoProveedor(ProveedorPanel panelPrincipal) {
    ...
    private void inicializarComponentes() {
        ...
        // Botón
        botonCrear = crearBoton("Crear Proveedor", new Color(37, 99, 235), e -> crearProveedor());
    }
    ...
    private void configurarVentana() {
        ...
        // Tamaño para la ventana - mismo estándar que DialogoNuevoProducto
    ...
    private JPanel crearPanelTitulo() {
        ...
        JLabel titulo = new JLabel("Ingresar Nuevo Proveedor");
    ...
    private JPanel crearPanelFormulario() {
        ...
        // Fila 1 - Nombre y Teléfono (mismo estilo que DialogoNuevoProducto)
    ...
    private void crearProveedor() {
        try {
            ...
            // Crear proveedor (convertir teléfono a número sin espacios ni +)
